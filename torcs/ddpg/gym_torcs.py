...
class TorcsEnv:
    ...
    def __init__(self, vision=False, throttle=False, gear_change=False):
        ...
        if self.vision is True:
            os.system('torcs -s -r /root/.torcs/config/raceman/practiceregcg.xml -nofuel -nodamage -nolaptime -vision  &')
        else:
            os.system('torcs -s -r /root/.torcs/config/raceman/practiceregcg.xml -nofuel  &')
        #time.sleep(0.5)
    ...
    def make_observaton(self, raw_obs):
        if self.vision is False:
            names = ['focus',
                     ...
                     'track',
                     'trackPos',
                     'wheelSpinVel', 'curLapTime', 'distFromStart', 'distRaced', 'lastLapTime']
