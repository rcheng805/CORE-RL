...
ppo_0 = loadmat('ppo/data/data0_ppo_v0.mat')
rewards_0 = np.array(ppo_0['data_total'])
ppo_1 = loadmat('ppo/data/data0_ppo_v1.mat')
rewards_1 = np.array(ppo_1['data_total'])
ppo_2 = loadmat('ppo/data/data0_ppo_v2.mat')
rewards_2 = np.array(ppo_2['data_total'])
ppo_3 = loadmat('ppo/data/data0_ppo_v3.mat')
rewards_3 = np.array(ppo_3['data_total'])
ppo_4 = loadmat('ppo/data/data0_ppo_v4.mat')
rewards_4 = np.array(ppo_4['data_total'])
ppo_5 = loadmat('ppo/data/data0_ppo_v5.mat')
rewards_5 = np.array(ppo_5['data_total'])
ppo_6 = loadmat('ppo/data/data0_ppo_v6.mat')
rewards_6 = np.array(ppo_6['data_total'])
ppo_7 = loadmat('ppo/data/data0_ppo_v7.mat')
rewards_7 = np.array(ppo_7['data_total'])
ppo_8 = loadmat('ppo/data/data0_ppo_v8.mat')
rewards_8 = np.array(ppo_8['data_total'])
ppo_9 = loadmat('ppo/data/data0_ppo_v9.mat')
